...
Ext.onReady(function () {
	if (Ext.grid.RowEditor) {
		Ext.grid.RowEditor.prototype.saveBtnText = 'Confirmar';
		Ext.grid.RowEditor.prototype.cancelBtnText = 'Cancelar';
		Ext.grid.RowEditor.prototype.errorsText = 'Erros';
		Ext.grid.RowEditor.prototype.dirtyText = 'Você precisa confirmar ou cancelar as alterações';
	}
	...
	if (Ext.AbstractView) {
		Ext.AbstractView.prototype.loadingText = "Carregando...";
	}
	...
	if (Ext.window.MessageBox) {
		...
		Ext.window.MessageBox.titleText = {
			confirm: "Confirma&ccedil;&atilde;o",
			prompt: "Digite",
			wait: "Carregando...",
			alert: "Aten&ccedil;&atilde;o"
	...
	if (Ext.form.Basic) {
		Ext.form.Basic.prototype.waitTitle = "Aguarde...";
	}
	...
	if (Ext.form.field.Month) {
		Ext.apply(Ext.form.field.Month.prototype, {
			disabledDaysText: "Desabilitado",
			disabledDatesText: "Desabilitado",
			minText: "A data deste campo deve ser posterior a {0}",
			maxText: "A data deste campo deve ser anterior a {0}",
	...
	if (Ext.form.field.VTypes) {
		Ext.apply(Ext.form.field.VTypes, {
			...
			emailText: 'Este campo deve ser um endere&ccedil;o de e-mail v&aacute;lido.',
			urlText: 'Este campo deve ser uma URL v&aacute;lida.',
